...
// 1. Dirigidas por Christopher Nolan.
...
const returnMovieTitle = (watchList) => {
    const directorFilter = watchList.filter((movie)=> movie.Director === "Christopher Nolan");
    const ratingFilter = directorFilter.filter((movie)=> movie.imdbRating > 8);
    const mapWachList = ratingFilter.map((nolanMovies)=> nolanMovies.Title)
